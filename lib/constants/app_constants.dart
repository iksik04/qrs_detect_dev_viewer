...
class AppColors {
  ...
  static const Color truePeakLine = Colors.red;      // истинные пики
  static const Color processedLine = Color.fromARGB(255, 112, 1, 127);   // обработанный сигнал (Pan-Tompkins)
